...
#.############################################################################################
  ...
  DP_natveg_outside_adj_flow = data.frame(Date = seq(start_date, end_date, "days"),                              # Import ILR flow data
  ...
  DP_natveg_gwmixed_outside_adj_flow = data.frame(Date = seq(start_date, end_date, "days"),                              # Import ILR flow data
