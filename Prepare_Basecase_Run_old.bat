...
xcopy SVIHM_Input_Files\time_independent_input_files\polygon_table.txt Run\SWBM /Y /I
...
xcopy SVIHM_Input_Files\time_independent_input_files\landcover_table.txt Run\MODFLOW /Y /I
