...
# Scenario Settings -----------------------------------------------------
scen <- list(
  'name'             = 'natveg_high_12k',  # Scenario name, will be part of directory name
  ...
  'irr_to_natveg_acres' = 12000     # number of irrigated acres to randomly convert to native vegetation
)
